...
function ChatPageContent() {
  ...
  useEffect(() => {
    ...
    const fetchChats = async () => {
        ...
        const teamsUnsubscribe = onSnapshot(teamsQuery, async (teamsSnapshot) => {
  ...
  return (
    <SidebarProvider>
        <div className="flex flex-1 overflow-hidden">
            <Sidebar side="left" className="w-80 border-r" collapsible="icon">
                <SidebarContent>
                     {loadingChats ? (
                        ...
                        <>
                         <SidebarGroup>
                            ...
                            <SidebarMenu>
                                {projectChats.length === 0 ? <p className="text-xs text-muted-foreground p-2">No project chats yet.</p> : projectChats.map(proj => (
                        ...
                        <SidebarGroup>
                            ...
                            <SidebarMenu>
                                {personalChats.length === 0 ? <p className="text-xs text-muted-foreground p-2">Follow users to start chatting.</p> : personalChats.map(chat => (
